...
exports.run = (client, message, params) => {
  message.channel.send(':diamond_shape_with_a_dot_inside: **Senin Şanslı Sayın** :diamond_shape_with_a_dot_inside: ')
    ...
    switch(random) {
        ...
        case 11: message.channel.send(':small_blue_diamond: 2 :small_blue_diamond: '); message.channel.send(''); break;case 12: message.channel.send(':small_blue_diamond: 5 :small_blue_diamond: '); message.channel.send(' '); break;
